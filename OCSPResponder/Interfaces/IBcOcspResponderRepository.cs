...
namespace OcspResponder.Core.Internal
{
    ...
    internal interface IBcOcspResponderRepository
    {
        ...
        bool SerialExists(BigInteger serial, X509Certificate issuerCertificate);
        ...
        CertificateRevocationStatus SerialIsRevoked(BigInteger serial, X509Certificate issuerCertificate);
        ...
        CaCompromisedStatus IsCaCompromised(X509Certificate caCertificate);
        ...
        AsymmetricKeyParameter GetResponderPrivateKey(X509Certificate caCertificate);
        ...
        AsymmetricKeyParameter GetResponderPublicKey(X509Certificate caCertificate);
        ...
        X509Certificate[] GetChain(X509Certificate issuerCertificate);
        ...
        IEnumerable<X509Certificate> GetIssuerCertificates();
